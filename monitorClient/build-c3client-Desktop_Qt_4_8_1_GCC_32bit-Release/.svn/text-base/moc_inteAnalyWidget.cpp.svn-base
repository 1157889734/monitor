...
static const char qt_meta_stringdata_inteAnalyWidget[] = {
    "inteAnalyWidget\0"
};
...
const QMetaObjectExtraData inteAnalyWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject inteAnalyWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_inteAnalyWidget,
      qt_meta_data_inteAnalyWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &inteAnalyWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_inteAnalyWidget))
        return static_cast<void*>(const_cast< inteAnalyWidget*>(this));
