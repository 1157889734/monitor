...
static const char qt_meta_stringdata_PresetPasswdConfirm[] = {
    "PresetPasswdConfirm\0\0sendCloseSignal()\0"
...
void PresetPasswdConfirm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        PresetPasswdConfirm *_t = static_cast<PresetPasswdConfirm *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData PresetPasswdConfirm::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PresetPasswdConfirm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PresetPasswdConfirm,
      qt_meta_data_PresetPasswdConfirm, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PresetPasswdConfirm::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PresetPasswdConfirm))
        return static_cast<void*>(const_cast< PresetPasswdConfirm*>(this));
