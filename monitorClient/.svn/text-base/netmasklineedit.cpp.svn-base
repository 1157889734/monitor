...
netmasklineedit::netmasklineedit(QWidget *parent) :
    QLineEdit(parent)
{
    m_ipPart1 = new MyNetMaskPartLineEdit(this);
    m_ipPart2 = new MyNetMaskPartLineEdit(this);
    m_ipPart3 = new MyNetMaskPartLineEdit(this);
    m_ipPart4 = new MyNetMaskPartLineEdit(this);
...
void netmasklineedit::showKeyboardSlot()
{
    //printf("iplineedit::showKeyboardSlot!\n");
    QObject* Object=sender();
    if(Object==0)
    {
        return ;
    }
    //printf("########%s-%s\n", Object->objectName().toAscii().data(), send_name.toAscii().data());
    ...
    if(flag_show%2==0)
    {
        //printf("iplineedit::showKeyboardSlot 11111\n");
...
void netmasklineedit::hideKeyboardSlot()
{
    //printf("NetWorkDialog::hideKeyboardSlot!\n");
    flag_show = 1;
    emit hideKeyboardSig();
}
