            ...
            : QLineEdit(parent)
{
    ...
    QValidator *validator = new QIntValidator(0, 254, this);
...
void MyIpPartLineEdit::textEditSlot(const QString& text)
{
    QIntValidator v(0, 254, this);
    QString ipaddr = text;
    int pos = 0;
...
void MyIpPartLineEdit::mousePressEvent(QMouseEvent *event) {
